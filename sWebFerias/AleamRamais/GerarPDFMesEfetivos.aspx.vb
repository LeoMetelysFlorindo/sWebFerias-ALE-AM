...
'Data de criação: 13/01/2016 10:36h
'Desenvolvedor: Leonardo Metelys - Gerência de Aplicativos - ALEAM
'Formulário de Geração Automática de PDF´s por mês de Efetivos
...
Public Class GerarPDFMesEfetivos
    ...
    Private Sub GerarDRT(Mes As String, MatInicial As String, MatFinal As String)
        ...
        strSQL = "SELECT matricula, nome, lotacao,1parcela13, periodo1,periodo2,periodo3,mes_ferias as MesFerias, diasferias, " & _
             ...
             "FROM colaborador where tipo ='EFETIVO' and mes_ferias like '" & Mes.ToUpper() & "' and matricula in ( " & MatFinal & "," & MatFinal & ")  order by Mes,lotacao "
    ...
    Private Sub GerarDadosMes(Mes As String)
        ...
        strSQL = "SELECT matricula, nome, lotacao,1parcela13, periodo1,periodo2,periodo3,mes_ferias as MesFerias, diasferias, " & _
             ...
             " when 'DEZEMBRO' THEN 12 " & _
             " when '0' THEN 13 END AS Mes " & _
             "FROM colaborador where tipo ='EFETIVO' and mes_ferias like '" & Mes.ToUpper() & "' order by Mes,lotacao"
