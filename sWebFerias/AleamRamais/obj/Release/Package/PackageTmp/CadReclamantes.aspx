...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="blocoGrupoCampos" style="margin-left: 25px; width: 800px;">
        <fieldset class="bordaFieldset" style="width:780px;">
            <legend>Cadastro de Comissionados</legend>
            ...
            <div class="blocoGrupoCampos"  style="margin-left: 0px; width: 800px;"> 
                 ...
                 <div class="blocoeditor">
                     <label>
                        Ativo</label>
                    <br />
                    <asp:TextBox ID="TxtAtivo" runat="server" Width="83px" TabIndex="6"></asp:TextBox>                    
                </div>
                <div class="blocoeditor">
                     <label>
                        Data Nascimento</label>
                    <br />
                    <asp:TextBox ID="TxtNascimento" runat="server" Width="124px" TabIndex="7"></asp:TextBox>                    
                </div>
                ...
                <div class="blocoeditor">
                     <label>
                        Dias</label>
                    <br />
                    <asp:TextBox ID="TxtDias" runat="server" Width="129px" TabIndex="7"></asp:TextBox>                    
                </div>
                ...
                <div class="blocoGrupoCampos"  style="margin-left: 25px;  width: 800px;">
                    ...
                    <div class="blocoeditor">
                        <br />
                        <asp:Button ID="BtnMenu" runat="server" Width="100px" Text="Imprimir" OnClick="btnMenu_Click" style="height: 26px" Visible="False" />
                    </div>
                     <div class="blocoeditor">
                        <br />
