...
'Data de criação: 06/01/2016 12:09h
'Desenvolvedor: Leonardo Metelys - Gerência de Aplicativos - ALEAM
'Formulário de Consulta de Férias ao Mês dos Comissionados
...
Public Class ConsMesFerias
    ...
    Private Sub CarregarGrid(ByVal NomeReclamado As String)
        ...
        strSQL = "SELECT matricula, nome, lotacao,1parcela13, periodo1,periodo2,periodo3,mes_ferias as MesFerias, " & _
             ...
             "FROM colaborador where tipo ='COMISSIONADO' and mes_ferias like '" & NomeReclamado.ToUpper() & "' order by lotacao"
