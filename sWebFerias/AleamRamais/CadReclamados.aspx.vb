...
'Data de criação: 05/01/2016 09:00
'Desenvolvedor: Leonardo Metelys - Gerência de Aplicativos - ALEAM
'Formulário de Cadastro dos Efetivos
Imports System.Data
...
Public Class CadReclamados1
    ...
    Protected Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles BtnNovo.Click, btnSalvar.Click
        ...
        Dim sCPF As String = ""
        Dim sCNPJ As String = ""
        Dim sEfetivo As String = "EFETIVO"
        ...
        If txtCodigo.Text <> "" Then
            ...
            Dim ssQL As String = "SELECT matricula FROM colaborador WHERE matricula  =  '" & Trim(txtCodigo.Text) & "' and tipo='EFETIVO'"
    ...
    Protected Sub bntPesquisar_Click(sender As Object, e As ImageClickEventArgs) Handles bntPesquisar.Click
        ...
        If txtCodigo.Text <> "" Then
            ...
            Objconn.Conectar()
            Objconn.Parametros.Clear()
            strSQL = "SELECT * FROM colaborador WHERE matricula =  '" & Trim(txtCodigo.Text) & "' and tipo='EFETIVO' "
